...
class TestFixTitle(unittest.TestCase):
    def test_fix_title_no_changes(self):
        ...
        v1.fix_title(warn=False)
        self.assertEqual(v1.title, "Band - Title")
        
        v2 = Song(None, "A New Better Band - Title, The Better Version", "Evil Channel >=D")
        v2.fix_title(warn=False)
    ...
    def test_fix_title_illegal_chars(self):
        ...
        v3 = Song("https://www.youtube.com/watch?v=e370GUVRlQo", "The Book Of Mormon: \"I Believe\"", "jbsdg")
        v3.fix_title(warn=False)
    ...
    def test_fix_title_parentheses(self):
        ...
        v1 = Song("https://www.youtube.com/watch?v=iywaBOMvYLI", " System Of A Down - Toxicity (Official HD Video)", "System Of A Down")
        v1.fix_title(warn=False)
        self.assertEqual(v1.title, "System Of A Down - Toxicity")
        
        v2 = Song("https://www.youtube.com/watch?v=Qzw6A2WC5Qo", "  Skillet - \"Feel Invincible\" [Official Music Video] ", "Skillet")
        v2.fix_title(warn=False)
        self.assertEqual(v2.title, "Skillet - Feel Invincible")
        
        v3 = Song("https://www.youtube.com/watch?v=1k8craCGpgs", "Journey - Don't Stop Believin' (Official Audio)", "journey")
        v3.fix_title(warn=False)
    ...
    def test_fix_title_hyphen(self):
        ...
        v = Song("https://www.youtube.com/watch?v=QRgrAEX6sR4", "Six Feet Under", "Smash Into Pieces")
        v.fix_title(warn=False)
    ...
    def test_fix_title_strings_to_remove(self):
        ...
        v1 = Song("https://www.youtube.com/watch?v=rB54MW0F3bg", "My Chemical Romance - Dead! Lyrics", "Muzic303")
        v1.fix_title(warn=False)
        self.assertEqual(v1.title, "My Chemical Romance - Dead!")
        
        v2 = Song(None, "My Chemical Romance - Dead! Lyrics 1080p (mega official video by Muzic303)", "Muzic303")
        v2.fix_title(warn=False)
